...
public class  PlaybackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int tipo = getIntent().getIntExtra(INTENT_NAME_VIDEO_PATH, -1);
        ...
        String pathV = "android.resource://" + getPackageName() + "/" + R.raw.video_file;

        mVvPlayback.setVideoURI(Uri.parse(pathV));
        ...
        pptViewer = (PPTViewer) findViewById(R.id.pv_ap_slide);
        ...
        if(permissionsAvailable) {
            ...
            if (i != null) {
                ...
                if (uri != null) {
                    ...
                    path = Environment.getExternalStorageDirectory() + File.separator + "android.ppt";
                    try {
                        CopyRAWtoSDCard(R.raw.android, path);
                    } catch (IOException e) {
                        e.printStackTrace();
